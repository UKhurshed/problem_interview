...
part "profile_repos_dao.g.dart";

@DriftAccessor(tables: [ProfileRepos])
class ProfileReposDao extends DatabaseAccessor<SearchReposDatabase>
    with _$ProfileReposDaoMixin {
  ProfileReposDao(super.attachedDatabase);
